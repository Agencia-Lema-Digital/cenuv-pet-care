...
const SymptomsSection = () => {
  return (
    <section id="sintomas" className="section-padding bg-white relative overflow-hidden" aria-labelledby="symptoms-heading">
      ...
      <div className="container-wide relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <img 
              src={vetCatExam} 
              alt="Veterinário examinando gato laranja com estetoscópio"
          ...
          <div>
            ...
            <motion.div 
              className="bg-gradient-to-r from-cenuv-peach to-cenuv-cream rounded-2xl p-6 border-l-4 border-primary mb-8"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
