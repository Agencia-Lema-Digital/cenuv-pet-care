        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          delay: 0.3
            ...
            <div className="relative">
              <img alt="Veterinária examinando cachorro com carinho em clínica moderna" className="w-full h-auto rounded-3xl image-premium border-solid object-scale-down" src="/lovable-uploads/d5fa911f-f350-4a08-a46a-1651c83c864f.png" />
              {/* Floating accent */}
