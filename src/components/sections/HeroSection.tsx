        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          delay: 0.3
            ...
            <div className="relative">
              <img src={heroImage} alt="Veterinária examinando cachorro com carinho em clínica moderna" className="w-full h-auto rounded-3xl image-premium object-cover border-solid" />
              {/* Floating accent */}
