...
const FinalCTASection = () => {
  return (
    <section id="contato" className="section-padding bg-gradient-to-br from-primary via-cenuv-dark-medium to-cenuv-dark-deep text-primary-foreground relative overflow-hidden" aria-labelledby="final-cta-heading">
      {/* Decorative elements */}
      ...
      <div className="container-wide relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <img 
              src={vetCatCloseup} 
              alt="Veterinário examinando gato com carinho e profissionalismo"
