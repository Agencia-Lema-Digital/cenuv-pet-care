...
const AuthoritySection = () => {
  return (
    <section id="diferenciais" className="section-padding bg-cenuv-peach relative overflow-hidden" aria-labelledby="authority-heading">
      {/* Decorative elements */}
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <img 
              src={vetUltrasound} 
              alt="Veterinários realizando ultrassom em cachorro"
        ...
        <motion.div 
          className="mt-12 bg-white rounded-2xl p-6 md:p-8 border-l-4 border-cenuv-orange max-w-3xl mx-auto"
        ...
        >
          <p className="body-lg text-foreground italic text-center">
