...
const SocialProofSection = () => {
  return (
    <section className="section-padding bg-gradient-to-br from-cenuv-gold/30 via-cenuv-peach to-cenuv-cream relative overflow-hidden" aria-labelledby="social-proof-heading">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative">
              <img 
                src={happyPetOwner} 
                alt="Tutora feliz abraçando seu cachorro recuperado"
