...
const ObjectionsSection = () => {
  return <section id="duvidas" className="section-padding bg-cenuv-cream relative overflow-hidden" aria-labelledby="objections-heading">
      {/* Decorative elements */}
      ...
      <div className="container-narrow relative z-10">
        <motion.h2 id="objections-heading" className="heading-lg text-foreground text-center mb-12 font-sans" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
        ...
        <motion.div className="space-y-6 max-w-2xl mx-auto" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{
        once: true
      }}>
          {objections.map((objection, index) => <motion.div key={index} className="bg-white rounded-2xl p-6 md:p-8 border-l-4 border-cenuv-orange" style={{
