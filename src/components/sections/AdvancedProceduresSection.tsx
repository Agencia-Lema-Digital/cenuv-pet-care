  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-background to-muted/30 relative overflow-hidden">
      ...
      <div className="absolute top-10 left-0 w-32 h-32 opacity-10">
        <img
          src="/src/assets/elements/blob-wine.png"
          alt=""
      ...
      <div className="absolute bottom-10 right-0 w-40 h-40 opacity-10">
        <img
          src="/src/assets/elements/abstract-wine.png"
          alt=""
          className="w-full h-full object-contain"
        />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          Todos os procedimentos são realizados por profissionais habilitados, 
          seguindo as diretrizes do Conselho Regional de Medicina Veterinária.
        </motion.p>
      </div>
    </section>
  );
