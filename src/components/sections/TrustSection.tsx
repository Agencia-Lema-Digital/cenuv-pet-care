...
const TrustSection = () => {
  return (
    <section className="section-padding bg-gradient-to-br from-primary via-cenuv-dark-medium to-primary text-primary-foreground relative overflow-hidden" aria-labelledby="trust-heading">
      {/* Decorative elements */}
      ...
      <div className="container-wide relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <img 
              src={vetComforting} 
              alt="Veterinária segurando cachorro branco com carinho"
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.p 
              className="body-lg leading-relaxed mb-10 opacity-95"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
